...
$up="UPDATE `patient_registration` SET `name`='".$_POST['n']."',`user name`='".$_POST['un']."',`age`='".$_POST['a']."',`gender`='".$_POST['g']."',`address`='".$_POST['add']."',`phone number`='".$_POST['ph']."',`email`='".$_POST['em']."' WHERE id='".$_SESSION['uid']."'";
mysqli_query($con,$up);

$upd="UPDATE `login` SET `username`='".$_POST['un']."' WHERE rid='".$_SESSION['uid']."' and type='patient'";
mysqli_query($con,$upd);
header("Location:profile.php");
  }
  else
  {
  $up="UPDATE `patient_registration` SET `name`='".$_POST['n']."',`user name`='".$_POST['un']."',`age`='".$_POST['a']."',`gender`='".$_POST['g']."',`address`='".$_POST['add']."',`phone number`='".$_POST['ph']."',`email`='".$_POST['em']."',`image`='$pic' WHERE id='".$_SESSION['uid']."'";
mysqli_query($con,$up);
...
$con=mysqli_connect("localhost","root","","find_my_doctor");
//session_start();
$q="select * from  patient_registration where id='".$_SESSION['uid']."'";
...
<tr><td>IMAGE</td><td><input type="file" name="pic" id="pic" /><img src="../image/<?php echo $f['image'];?>" height="50" width="50"/></td></tr>
...
<tr>
<td>USERNAME</td>
<td><input type="textbox" name="un" value="<?php echo $f['user name'];?>" class="form-control"></td>
</tr>
<tr>
