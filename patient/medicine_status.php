...
<body>
	<?php
                ...
                session_start();
                 $a="SELECT * FROM `medicine_booking` WHERE pid='".$_SESSION['uid']."'";
					...
					<div class="about_box">
                    	<div class="activity">
							<div class="row">
								...
								<div class="" style="margin-left:300px">
									<div class="activity_boxg" >
									<p ><b style="color:#000000">ACCEPTED</b></p>	
									</div>
								</div>
								<div class="" style="margin-left:10px">
									<div class="activity_boxr">
										<p ><b style="color:#000000">REJECTED</b></p>
									</div>
								</div>
								<div style="margin-left:10px">
									<div class="activity_boxo">
										<p ><b style="color:#000000">PENDING</b></p>
									</div>
								</div>
							</div>
						</div>
						<div class="section-title-wrap text-left">
							...
							while($r=mysqli_fetch_array($e))
							{
								if($r['status']=='APPROVE')
  								{
								  $b="SELECT * FROM `medicine` WHERE id='".$r[1]."'";
								  $x=mysqli_query($con,$b);
								  while($m=mysqli_fetch_array($x))
								  {?>
  
                                    <tr>
                                    <td><font color="#00FF00"><?php echo $m[1];?></font></td>
                                    <td><font color="#00FF00"><?php echo $r[3];?></font></td>
                                    <td><font color="#00FF00"><?php echo $r[4];?></font></td>
                                    <td><font color="#00FF00"><?php echo $r['date'];?></font></td>
                                    </tr>
                                    <?php
                                    }
								}
								elseif($r['status']=='REJECT')
								  ...
								  {?>
                                    ...
                                    <tr>
                                    <td><font color="#FF0000"><?php echo $m[1];?></font></td>
                                    <td><font color="#FF0000"><?php echo $r[3];?></font></td>
                                    <td><font color="#FF0000"><?php echo $r[4];?></font></td>
                                    <td><font color="#FF0000"><?php echo $r['date'];?></font></td>
                                    </tr>
                                    <?php
                                    }
								}
								else
								{
								  ...
								  {?>
                                    ...
                                    <tr>
                                    <td><font color="#D5CF0B"><?php echo $m[1];?></font></td>
                                    <td><font color="#D5CF0B"><?php echo $r[3];?></font></td>
                                    <td><font color="#D5CF0B"><?php echo $r[4];?></font></td>
                                    <td><font color="#D5CF0B"><?php echo $r['date'];?></font></td>
                                    </tr>
                                    <?php
                                    }
								}
