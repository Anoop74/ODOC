                ...
                <div class="col-lg-8">
                    <div class="blog_left_sidebar">
                      ...
                      <div class="col-md-9" style="float:left">
                                <div class="blog_post">
                        <img src="../image/<?php if(strpos($f[5],",")!==false){  echo substr($f[5],0,strpos($f[5],","));}else{ echo $f[5];};?>" height="300px" width="500px" alt="">
                                    <div class="blog_details">
                                        
                                            <h2><?php echo $f[3];?></h2>
                                        
                                        <p><?php  echo substr($f[4],0,50)."....."?></p>
                                        <a href="view_exercisedtls.php?id=<?php echo $f[0];?>" class="white_bg_btn">View More</a>
                                    </div>
                                </div>
                            </div>
                        </article>
