	...
	<div class="whole-wrap">
		<div class="container">
			<div class="section-top-border">
				<h3 class="mb-30 title_color">MEDICINES</h3>
				<div class="progress-table-wrap">
					<div class="progress-table">
                    <div class="table-head">
							<div class="serial">#</div>
							<div class="country">MEDICINE</div>
							<div class="visit">USAGE</div>
					...
					?>
						...
						<div class="table-row">
							...
							<div class="country"><?php echo $r[1];?></div>
							<div class="visit"><?php echo $r[3];?></div>
							<div class="percentage"><font color="red"><?php echo "out of stock";?></font></div>
						</div>
                        <?php
					}
					...
					?>
                    	<div class="table-row">
							...
							<div class="country"><?php echo $r[1];?></div>
							<div class="visit"><?php echo $r[3];?></div>
							<div class="percentage"><a href="book.php?id=<?php echo $r[0];?>" class="genric-btn success circle">Book</a></div>
						</div>
                    <?php
					}
					$i=$i+1;
