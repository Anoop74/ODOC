			...
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<div class="single_service">
						...
						<p>
							odoc is providing 24/7 customer care services 
							</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="single_service">
						...
						<p>
							Expert consuling service by well qualified doctors
						</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="single_service">
						...
						<p>
							Specialised treatment given to patients who require criticl medical care
						</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="single_service">
						...
						<a href="#">
							<h4>Online medicines</h4>
						</a>
						<p>
							Patients can buy medicines through online pharmacy
						</p>
					</div>
				</div>
			</div>
...
$a="SELECT * FROM `hospital_facilities`";
...
<td><img src="../image/<?php echo $r['image'];?>" height="100" width="100"></td>
 <?php
}
?></table>
      </div>
