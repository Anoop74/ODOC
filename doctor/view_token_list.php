...
$a="select * from  doctor_details where did='".$_SESSION['uid']."'";
$ex=mysqli_query($con,$a);
...
<header class="header_area">
            ...
            <div class="container">
                <div class="banner_content text-left">
                    ...
                    <div class="page_link">
                        ...
                        <a href="view_token_list.php">Appoinment Details</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--================Blog Area =================-->
    <section class="blog_area single-post-area p_12">
        <div class="container">
          <div class="row">
              <div class=" posts-list" style="margin-left:200px; width:800px">
...
<tr>
<td>WORKING TIMINGS :</td>
<td><?php echo $r[3];?> To <?php echo $r[4];?></td>
</tr>
<tr>
<td>MAX TOKEN NO :</td>
<td><?php echo $r[5];?> </td>
...
<center><h1>TOKEN LIST</h1>
<table>

<tr><td></td><td><input type="date" name="dt" class="form-control" value="<?php echo $cd;?>" style="width:200px; margin-left:230px">
<input type="submit" name="ok" value="OK" class="btn submit_btn" style="margin-left:280px; margin-top:20px"></td></tr></table>
...
if(isset($_POST['ok']))
{
	$s="SELECT * FROM `token` WHERE did='".$_SESSION['uid']."' and bdate='".$_POST['dt']."'";
	...
	{?>
        ...
        <?php
            $i=1;
          while($x=mysqli_fetch_array($ss))
          {
            $a="SELECT * FROM `patient_registration` WHERE id='".$x[2]."'";
           ...
           {	
            ...
            <tr>
                ...
                if($x['status']=="cancel")
                {?>
                <td><font color="#FF0000">Cancelled</font></td>
                <?php
                }
                else
                {
                ?>
                <td><?php echo $x['token_no'];?></td>
                <?php
                }
  ...
  {
   ?><center><font color="#FF0000" size="+3" face="Arial, Helvetica, sans-serif"><?php echo "NO BOOKINGS";?></font></center>
   <?php
  }
 }
?>
