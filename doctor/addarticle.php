...
function validation()
{
 ...
 else if(document.getElementById('article').value.length==0)
 {
...
move_uploaded_file($_FILES['image']['tmp_name'],"../image/".$img);
  $dt=date("y-m-d");
 $q="INSERT INTO `article`(`aid`, `did`, `date`, `title`, `description`, `image`) VALUES ('','".$_SESSION['uid']."','$dt','$title','$article','$img')";
  mysqli_query($con,$q);
 ?>
 <script type="text/javascript">
    ...
    <section class="contact_area p_100">
        <div class="container">
          <div class="row" style="margin-right:100px">
            ...
            <tr><td>ARTICLE :</td><td><input type="text" name="title" id="title" class="form-control" ></td></tr>
            <tr><td>DESCRIPTION :</td><td><textarea name="article" id="article" rows="5"  class="form-control"></textarea></td></tr>
...
<table align="center" border="1" style="margin-top:50px">
			<?php $c="select * from  article where did='".$_SESSION['uid']."'";
  ...
  {?>
    ...
    <td><a href="edit_article.php?id=<?php echo $r[0];?>" class="genric-btn success circle">EDIT</a></td>
    <td><a href="delete_article.php?id=<?php echo $r[0];?>" class="genric-btn danger circle">DELETE</a></td>
	</tr>
	<?php
    $i=$i+1;
	}
