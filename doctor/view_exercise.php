            ...
            <div class="container">
                <div class="banner_content text-left">
                    ...
                    <div class="page_link">
                        ...
                        <a href="view_diet.php">Exercise</a>
                    </div>
                </div>
            </div>
        </div>
...
if(isset($_POST['search']))
{
	...
	if($fd!="" && $td!="")
	{
		$sql="select * from exercise where did!='$uid' and date between '$fd' and '$td'  limit $start_from,$num_per_page";
		$exe=mysqli_query($con,$sql);
		$sql1="SELECT * FROM `exercise` WHERE did!='$uid' and date between '$fd' and '$td'";
		$exe1=mysqli_query($con,$sql1);

	}
	else
	{
		$sql="select * from exercise where did!='$uid' limit $start_from,$num_per_page";
		$exe=mysqli_query($con,$sql);
...
<a href="view_exercise.php?page=<?php echo $page-1;?>">prev</a>
<?php
}
?>
<?php
...
{
	?>
    <a href="view_exercise.php?page=<?php echo $i;?>"><?php echo $i;?></a>
    <?php
}
?>
...
{
	?>
<a href="view_exercise.php?page=<?php echo $page+1;?>">next</a>
<?php
}
?></center></form>
        </div>
