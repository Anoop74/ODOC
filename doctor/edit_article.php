...
<body>
   <?php
				...
				session_start();
				$idd=$_GET['id'];
				$q="select * from  article where aid='$idd' and did='".$_SESSION['uid']."'";
    ...
    <section class="contact_area p_120">
        <div class="container">
          <div class="row" style="margin-left:300px">
            ...
            <table align="center">
            <tr><td>ARTICLE :</td>
            <td><input type="text" name="a"  id="a" value="<?php echo $f['title'];?>" class="form-control"></td></tr>
            <tr><td>DESCRIPTION :</td><td><textarea name="ab"  id="article" class="form-control"><?php echo $f['description'];?></textarea></td></tr>
...
$up="UPDATE `article` SET  `date`='$dt',`title`='".$_POST['a']."',`description`='".$_POST['ab']."' WHERE  aid='$idd'";
mysqli_query($con,$up);
...
//header("Location:doctor_home.php");
  ...
  {
  $up="UPDATE `article` SET  `date`='$dt',`title`='".$_POST['a']."',`description`='".$_POST['ab']."',`image`='$img' WHERE  aid='$idd'";
mysqli_query($con,$up);
