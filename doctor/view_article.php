...
//$sql="select * from student inner join login on student.id=login.rid";
...
if(isset($_POST['search']))
{
	...
	if($fd!="" && $td!="")
	{
		$sql="select * from article where did!='$uid' and date between '$fd' and '$td'  limit $start_from,$num_per_page";
		$exe=mysqli_query($con,$sql);
		$sql1="SELECT * FROM `article` WHERE did!='$uid' and date between '$fd' and '$td'";
		$exe1=mysqli_query($con,$sql1);

	}
	else
	{
		$sql="select * from article where did!='$uid'  limit $start_from,$num_per_page";
		$exe=mysqli_query($con,$sql);
		$sql1="SELECT * FROM `article` where did!='$uid'";
		$exe1=mysqli_query($con,$sql1);
	}	
}
else
...
{?>
<font color="#FF0000" size="+3" face="Times New Roman, Times, serif"><?php echo "NO ARTICLES FOUND";?></font>
<?php
}
?>
</table><center>
...
{
?>   
<a href="view_article.php?page=<?php echo $page-1;?>">prev</a>
<?php
}
?>
<?php
...
{
?>
<a href="view_article.php?page=<?php echo $i;?>"><?php echo $i;?></a>
<?php
}
?>
<?php
...
{
?>
<a href="view_article.php?page=<?php echo $page+1;?>">next</a>
<?php
}
?>
</center></form>
