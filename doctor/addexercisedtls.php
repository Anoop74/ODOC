...
function validation()
{
 ...
 {
   alert("please enter about exercise");
...
$q="INSERT INTO `exercise`(`eid`, `did`, `date` , `about`, `description`, `image`) VALUES ('','".$_SESSION['uid']."','$dt','$about','$dscrpn','$img')";
  mysqli_query($con,$q);
	 ?>
 <script type="text/javascript">
 alert("inserted successfully");
 window.location.href="addexercisedtls.php";
 </script>
 <?php
 }
    ...
    <section class="contact_area p_120">
        <div class="container">
          <div class="row" style="margin-left:300px">
            ...
            <tr><td>EXERCISE :</td><td><input type="text" name="at" id="at" class="form-control" ></td></tr>
...
<table align="center" border="1" style="margin-top:50px">
			...
			$c="select * from  exercise where did='".$_SESSION['uid']."'";
            ...
            {?>
				...
				<td><a href="edit_exercise.php?id=<?php echo $r[0];?>" class="genric-btn success circle">EDIT</a></td>
				<td><a href="delete_exercise.php?id=<?php echo $r[0];?>" class="genric-btn danger circle">DELETE</a></td>
				</tr>
				<?php
				$i=$i+1;
				}
