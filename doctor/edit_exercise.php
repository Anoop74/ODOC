...
<body>
  <?php
			...
			session_start();
			$idd=$_GET['id'];
			$q="select * from  exercise where eid='$idd' and did='".$_SESSION['uid']."'";
    ...
    <section class="contact_area p_120">
        <div class="container">
          <div class="row" style="margin-left:300px">
            ...
            <table align="center">
            <tr><td>EXERCISE :</td>
            <td><input type="text" name="a" id="at" value="<?php echo $f['about'];?>" class="form-control"></td></tr>
...
$up="UPDATE `exercise` SET  `date`='$dt',`about`='".$_POST['a']."',`description`='".$_POST['ab']."' WHERE  eid='$idd'";
mysqli_query($con,$up);
...
//header("Location:doctor_home.php");
  ...
  {
  $up="UPDATE `exercise` SET  `date`='$dt',`about`='".$_POST['a']."',`description`='".$_POST['ab']."',`image`='$img' WHERE  eid='$idd'";
mysqli_query($con,$up);
