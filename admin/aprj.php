...
<h2 class="mb-4">MEDICINE BOOKING</h2>

<form method="post" enctype="multipart/form-data">
<table border="1" style="margin-left:-230px">
...
$a=$_GET['id'];
$i=1;
$b="SELECT * FROM  `medicine_booking` where pid='$a' and status='pending'";
$e=mysqli_query($con,$b);
while($r=mysqli_fetch_array($e))
{
	$c="SELECT * FROM  `medicine` where id='".$r[1]."'";
	$x=mysqli_query($con,$c);
	while($m=mysqli_fetch_array($x))
	{
			...
			<td><?php echo $r[3];?></td>
			<td><?php echo $r[4];?></td>
            <td><a href="apbook.php?id=<?php echo $r['id'];?>&q=<?php echo $r[3];?>&qt=<?php echo $m[4];?>&mid=<?php echo $r[1];?>" class="genric-btn info circle">APPROVE</a>
            <a href="rjbook.php?id=<?php echo $r['id'];?>" class="genric-btn danger circle">REJECT</a></td>
            </tr>
