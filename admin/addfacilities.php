...
FACILITY :<input type="text" name="fc" required="required" class="form-control" style="width:250px"><br>
ABOUT :<textarea name="ab" required="required" class="form-control" style="width:250px"></textarea><br>
IMAGE :<input type="file" name="ph"  class="form-control"style="width:250px"  required="required"><br>
<input type="submit" value="SUBMIT" name="submit" class="btn submit_btn">
	...
	if(isset($_POST['submit']))
	{
		...
		$ph=$_FILES['ph']['name'];
			...
			move_uploaded_file($_FILES['ph']['tmp_name'],"../image/".$ph);
		
	
		$d="INSERT INTO `hospital_facilities`(`id`, `hid`, `name`, `description`, `photo`) VALUES ('','".$_SESSION['uid']."','$fc','$ab','$ph')";
		mysqli_query($con,$d);
	...
	?>
	<form method="post" enctype="multipart/form-data">
<table align="center" border="1" style="margin-left:-200px; margin-top:50px">

<?php
$con=mysqli_connect("localhost","root","","find_my_doctor");
$v="select * from hospital_facilities";
...
<td>
<img src="../image/<?php echo $g['photo'];?>" height="100px" width="100px" />
</td>
<td><a href="hsptlfc_edit.php?id=<?php echo $g['id'];?>" class="genric-btn info circle">EDIT</a></td>
<td><a href="hsptlfc_delete.php?id=<?php echo $g['id'];?>" class="genric-btn danger circle">DELETE</a></td>
</tr>
<?php
$i=$i+1;
}
