...
<body>
   ...
   <section class="team-area section_gap">
            ...
            $a="SELECT * FROM `doctor_registration` WHERE status='approved'";
            ...
            ?>
				...
				<div class="col-lg-3 col-md-6 single-team mb-50">
					<div class="thumb">
						<img class="img-fluid" src="../image/<?php echo $r['image'];?>"  height="100px" width="100px"alt="">
