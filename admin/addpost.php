...
TITLE :<input type="text" name="s" id="s" required="required" class="form-control" style="width:250px"><br>

COMMENTS :<textarea name="cmnt" required="required"class="form-control" style="width:250px"></textarea><br>
IMAGE :<input type="file" name="img" required class="form-control" style="width:250px"/><br>
<input type="submit" value="SUBMIT" name="submit" class="btn submit_btn">
	...
	if(isset($_POST['submit']))
	{
		...
		$d="INSERT INTO `post`(`id`, `title`, `comment`, `image`, `date`) VALUES  ('','$s','$cmnt','$img','$dt')";
		mysqli_query($con,$d);
...
<td><?php echo $f[1];?></td>
<td><?php echo $f[2];?></td>
<td><img src="../image/<?php echo $f[3];?>" height="50px" width="50px"/></td>
<td><?php echo $f[4];?></td>
<td><a href="delete.php?id=<?php echo $f[0];?>" class="genric-btn danger circle">DELETE</a></td>
</tr>
<?php
$i=$i+1;
}
