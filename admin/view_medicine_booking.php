...
$a="SELECT distinct(pid) FROM `medicine_booking` WHERE  status='pending'";
...
{?>
    ...
    {
		$b="SELECT * FROM `patient_registration` WHERE id='".$r['pid']."'";
		...
		while($m=mysqli_fetch_array($x))
		{
			...
			?>
                ...
                <td><?php echo $m[6];?></td>
                <td><a href="aprj.php?id=<?php echo $r['pid'];?>" class="genric-btn info circle">View</a></td>
...
{
?>
 <font color="#FF0000" size="+3" face="Times New Roman, Times, serif" style="margin-top:50px"><?php echo "NO REQUESTS FOUND";?></font>
 <?php
}
?>
</tr>
