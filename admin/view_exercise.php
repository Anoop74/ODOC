...
<h2 class="mb-4">EXERCISE DETAILS</h2>
...
<td><?php  echo substr($r[4],0,50)."....."?><a href="view_exercisedtls.php?id=<?php echo $r[0];?>">ReadMore</a></td>
<td><img src="../image/<?php echo $r[5];?>" height="100" width="100"></td><?php
$b="SELECT * FROM  doctor_registration where id='".$r[1]."'";
$ex=mysqli_query($con,$b);
$f=mysqli_fetch_array($ex);
?>
<td>Dr <?php echo $f[1];?></td>
...
{
?>
 <font color="#FF0000" size="+3" face="Times New Roman, Times, serif"><?php echo "NO EXERCISE DETAILS FOUND";?></font>
 <?php
}
?></table></center>
