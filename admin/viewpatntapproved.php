...
<h2 class="mb-4">PATIENTS LISTS</h2>
  <form method="post">

<input type="submit" name="approve" value="APPROVED" class="genric-btn success">&nbsp;&nbsp;&nbsp;<input type="submit" name="reject" value="REJECTED" class="genric-btn danger"><br />
...
$v="select * from patient_registration where status='approve'";
...
<td><a href="p_reject.php?id=<?php echo $g['id'];?>" class="genric-btn danger circle">REJECT</a></td>
</tr>
<?php
$i=$i+1;
}
...
$i=1;
$con=mysqli_connect("localhost","root","","find_my_doctor");
$v="select * from patient_registration where status='reject'";
$f=mysqli_query($con,$v);
if(mysqli_num_rows($f)>0)
{?>
<table style="margin-top:50px; margin-left:-200px">
...
<td><a href="p_approve.php?id=<?php echo $g['id'];?>" class="genric-btn info circle">APPROVE</a></td>
