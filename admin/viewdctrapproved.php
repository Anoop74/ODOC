...
<body>
   ...
   <section class="team-area section_gap">
		  <!-- Page Content  -->
      <div id="content" class="p-4 p-md-5" style="margin-right:50px">
...
?>
<select name="ql"  id="ql" class="form-control" style="width:200px"><option>SPECIALIZATION</option>
<?php
...
<input type="submit" name="ok" value="OK" onClick="return validation()" class="btn submit_btn" style="margin-top:1px">
...
if(isset($_POST['ok']))
{?>
    <table align="center" style="margin-top:40px" border="1">
    <tr>
    <th>#</th>
    <th>NAME</th>
    <th>AGE</th>
    ...
    <?php
	$i=1;
	$v="select * from doctor_registration where status='approved' and specialization='".$_POST['ql']."'";
	...
	while($g=mysqli_fetch_array($f))
	{
		...
		<td><img src="../image/<?php echo $g['image'];?>" height="70" width="70"/></td>
		<td><?php echo $g['address'];?></td>
		<td><?php echo $g['email'];?></td>
		<td><?php echo $g['phone number'];?></td>
		<td><?php echo $g['specialization'];?></td>
		<td><?php echo $g['qualification'];?></td>
		<td><a href="dctr_reject.php?id=<?php echo $g['id'];?>" class="genric-btn danger circle">REJECT</a></td>
